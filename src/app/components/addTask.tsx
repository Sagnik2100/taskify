    ...
    return (
        <div>
            <form onSubmit={AddTask}>
                ...
                <input type="text" className="shadow-md rounded" name="title" value={TaskData.title} onChange={(e) => setTaskData({ ...TaskData, title: e.target.value })} ></input>

                <label htmlFor="desc" > Add Description </label>
                <input type="text" className="shadow-md rounded" name="desc" value={TaskData.desc} onChange={(e) => setTaskData({ ...TaskData, desc: e.target.value })}></input>
